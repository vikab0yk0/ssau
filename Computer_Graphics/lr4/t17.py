...
def draw_triangle(point0, point1, point2, norm0, norm1, norm2, image):
    (x0, y0, z0), (x1, y1, z1), (x2, y2, z2) = point0, point1, point2
...
for face in f:
    ...
    draw_triangle(points[0], points[1], points[2], norms[0], norms[1], norms[2], img_mat)

img = Image.fromarray(img_mat, mode='RGB')
img = ImageOps.flip(img)
img.save('../images/gouraud_shading.png')